...
<div class="container-fluid">
  <div class="col-md-12">
    <div class="row">
      ...
      <h1 class='font-monospace my-3 text-center '>Mens Fashions clothes and shoes</h1>
      <?php
     include 'config.php';
     ...
     while($row=mysqli_fetch_array($reco)){
      ...
      if($chec ==='Men')
      {
       ...
       <input type='number' value='min='1' name='quan' max='30' placeholder='Quantity'><br><br>
       <input type='Submit' name='addcart' class='btn btn-primary text-center text-white w-80' value='Add to Cart'> 
       </div>
       </div>
       </form>
       </div> 
